...
const SingleBlog = ({history}) => {
    ...
    useEffect(()=>{
        settingBlog(localStorage.getItem('blogId'));
    },[])
    ...
    return (
        <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
              <button onClick={goBack} className="bg-gray-200 px-4 py-2 rounded-md mr-4">Back</button>
            <div className="xl:w-2/6 lg:w-2/5 w-80 md:block hidden">
                <img className="w-full" alt="img of a girl posing" src={blog?.imageUrl} />
                <img className="mt-6 w-full" alt="img of a Blogs" src="https://i.ibb.co/qxkRXSq/component-image-two.png" />
            </div>
            ...
            <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
                ...
                <div className="border-b border-gray-200 pb-6">
                    <p className="text-sm leading-none text-gray-600">Blogs Fall Collection</p>
                    ...
                    >
                        ...
                        <Link onClick={()=>localStorage.setItem("updateId",blog?._id)} to="/updatePost" className="border rounded px-3 py-1 text-sm">Edit</Link>
                    </div>
                </div>
                <div className="py-4 border-b border-gray-200 flex items-center justify-between">
                    <p className="text-base leading-4 text-gray-800">Catogary</p>
                    <div className="flex items-center justify-center">
                        <p className="text-sm leading-none text-gray-600">{blog?.category}</p>
                        <div
                            className="
								w-6
								h-6
                ...
                <div className="py-4 border-b border-gray-200 flex items-center justify-between">
                    <p className="text-base leading-4 text-gray-800">Published On</p>
                    <div className="flex items-center justify-center">
                        <p className="text-sm leading-none text-gray-600 mr-3">{blog?.publishingDate}</p>
                        <svg className="cursor-pointer" width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 1L5 5L1 9" stroke="#4B5563" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </div>
                ...
                <div>
                    <div className="border-t border-b py-4 mt-7 border-gray-200">
                        <div onClick={() => setShow(!show)} className="flex justify-between items-center cursor-pointer">
                            <p className="text-base leading-4 text-gray-800">Delete and Update</p>
                            <button
                                className="
									cursor-pointer
                        ...
                        You will be solely responsible for any legal action resulting from misleading content posted on your blog.
                        </div>
                    </div>
                </div>
                <div>
                    <div className="border-b py-4 border-gray-200">
                        ...
                        <div className={"pt-4 text-base leading-normal pr-12 mt-4 text-gray-600 " + (show2 ? "block" : "hidden")} id="sect">
                            If you have any questions on how to Post,delete,edit and get these Lastest Blogs Post, contact us.
                        </div>
                    </div>
                </div>
            </div>
